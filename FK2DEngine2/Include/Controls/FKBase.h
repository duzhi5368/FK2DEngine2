	...
	namespace Controls
	{
		...
		class FK_EXPORT Base : public Event::Handler
		{
			...
			public:
				...
				virtual void SetToolTip( const FK2DEngine2::TextObject & strText );
				...
				template <typename T>
				void AddAccelerator( const TextObject & accelerator, T func, FK2DEngine2::Event::Handler* handler = NULL )
				{
					if ( handler == NULL )
					{ handler = this; }
			...
			public:
				...
				virtual TextObject GetChildValue( const FK2DEngine2::String & strName );
