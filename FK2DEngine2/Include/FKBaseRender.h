	...
	namespace Renderer
	{
		...
		class ICacheToTexture
		{
			public:
				...
				virtual void SetRenderer( FK2DEngine2::Renderer::Base* renderer ) = 0;
		...
		class FK_EXPORT Base
		{
			public:
				...
				virtual void LoadTexture( FK2DEngine2::Texture* pTexture ) {};
				virtual void FreeTexture( FK2DEngine2::Texture* pTexture ) {};
				virtual void DrawTexturedRect( FK2DEngine2::Texture* pTexture, FK2DEngine2::Rect pTargetRect,
					float u1 = 0.0f, float v1 = 0.0f, float u2 = 1.0f, float v2 = 1.0f ) {};
				virtual void DrawMissingImage( FK2DEngine2::Rect pTargetRect );
				virtual FK2DEngine2::Color PixelColour( FK2DEngine2::Texture* pTexture, unsigned int x, unsigned int y,
