	...
	namespace Skin
	{
		...
		class FK_EXPORT Base
		{
			public:
				...
				Base( FK2DEngine2::Renderer::Base* renderer = NULL )
				{
				...
				virtual void SetRender( FK2DEngine2::Renderer::Base* renderer )
				{
					m_Render = renderer;
				}
				virtual FK2DEngine2::Renderer::Base* GetRender()
				{
					return m_Render;
				}
			...
			protected:
				...
				FK2DEngine2::Renderer::Base* m_Render;
